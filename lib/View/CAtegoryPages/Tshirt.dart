...
class ShirtPagee extends StatefulWidget {
  // Add productType parameter

  const ShirtPagee({Key? key,}) : super(key: key);

  @override
  State<ShirtPagee> createState() => _ShirtPageeState();
}

class _ShirtPageeState extends State<ShirtPagee> {
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ProductList(
                productList: productController.tshirts, // Pass the product type to getProductList
