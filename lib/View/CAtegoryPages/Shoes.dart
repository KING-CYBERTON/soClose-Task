...
class ShoeCard extends StatelessWidget {
  ...
  const ShoeCard({Key? key, required this.index}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (productController.shoes.isEmpty) {
          return CircularProgressIndicator();
        }

        final product = productController.shoes[index];
