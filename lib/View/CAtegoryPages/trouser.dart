...
class TrouserPagee extends StatefulWidget {
  // Add productType parameter

  const TrouserPagee({Key? key,}) : super(key: key);

  @override
  State<TrouserPagee> createState() => _TrouserPageeState();
}

class _TrouserPageeState extends State<TrouserPagee> {
      ...
      body: Container(
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ProductList(
                productList: productController.trousers, // Pass the product type to getProductList
