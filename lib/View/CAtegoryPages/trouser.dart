                ...
                children: [
                  Expanded(
                    child: GridView.builder(
                      itemCount: productController.trousers.length,
                      ...
                      itemBuilder: (context, index) {
                        return TrouserCard(index: index);
                      },
                    ),
                  ),
                ],
...
class TrouserCard extends StatelessWidget {
  final int index;

  const TrouserCard({Key? key, required this.index}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () {
        if (productController.trousers.isEmpty) {
          return CircularProgressIndicator();
        }

        final product = productController.trousers[index];
